...
public class ClientEvents {
    ...
    public static void onClientLogout(ClientPlayerNetworkEvent.LoggingOut event) {
        ...
        // Datapack components are per-connection; without this they leak into the next world/server.
    ...
    private static void spawnParticlesFor(Level level, PortalEntity portal) {
        ...
        org.joml.Vector3f color = portal.isDialed()
                ? new org.joml.Vector3f(0.15f, 0.85f, 1.0f)   // teal
                : new org.joml.Vector3f(1.0f, 0.30f, 0.70f);  // pink
