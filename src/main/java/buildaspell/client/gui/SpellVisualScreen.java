...
public class SpellVisualScreen extends Screen {
    ...
    protected void init() {
        ...
        // The sliders stay live in both color modes: touching one is an unambiguous request for a
        // custom color, so it switches the mode instead of doing nothing. A disabled slider only
    ...
    private static class RgbSlider extends AbstractSliderButton {
        ...
        protected void updateMessage() {
            // No explicit color: AbstractSliderButton signals active/inactive purely through the
            // text color it passes to the label, and a hardcoded style overrides it.
        ...
        public void onClick(MouseButtonEvent event, boolean doubleClick) {
            ...
            // where it already sits is still a request for a custom color.
