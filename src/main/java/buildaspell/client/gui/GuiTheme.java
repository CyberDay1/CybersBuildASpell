...
public final class GuiTheme {
    ...
    public static void fillVGradient(GuiGraphics g, int x, int y, int w, int h, int top, int bot) {
        for (int i = 0; i < h; i += 2) {
    ...
    public static void drawCorners(GuiGraphics g, int x, int y, int w, int h, int color, int len) {
    ...
    public static void drawSlot(GuiGraphics g, int x, int y, int size, int accent, boolean hovered) {
    ...
    public static void roundedRect(GuiGraphics g, int x0, int y0, int x1, int y1, int radius, int color) {
        roundedGradient(g, x0, y0, x1, y1, radius, color, color);
    }

    /** A rounded-corner rectangle filled with a top→bottom gradient. */
    public static void roundedGradient(GuiGraphics g, int x0, int y0, int x1, int y1, int radius, int topColor, int bottomColor) {
        int h = y1 - y0;
        if (h <= 0 || x1 <= x0) return;
    ...
    public static void drawSlotParticles(GuiGraphics g, int x, int y, int size, int accent, int seed) {
