...
public class SpellGuidebookLangProvider extends AbstractModonomiconLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        // --- GUI: Arcane Altar ---
        add("gui.buildaspell.arcane_altar.help.flow",
                "Place an item in the altar, pick a type, and set a target level.");
        add("gui.buildaspell.arcane_altar.help.targets",
                "Each type is read from one place: Spell Power from the main hand (a wand or a weapon), "
                        + "Mana Pool and Mana Regeneration from worn armor.");
        add("gui.buildaspell.arcane_altar.mismatch", "Wrong item");
        add("gui.buildaspell.arcane_altar.requires_armor",
        ...
        add("gui.buildaspell.spell_builder.needs_projectile", "Needs a projectile delivery (Cast or Tracking).");
        ...
        add("gui.buildaspell.spell_builder.palette_delivery_modifiers", "Delivery Modifiers");
        ...
        addModifier(SpellModifier.FILL, "Fill", "Fills a sphere, through walls");
