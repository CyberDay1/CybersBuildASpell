...
public class UpheavalCombosEntry extends EntryProvider {
    ...
    protected BookIconModel entryIcon() {
        // 26.2's copper weathering rework turned Items.LIGHTNING_ROD into a collection of the five
        // weathering stages; the unaffected one is still minecraft:lightning_rod.
        return BookIconModel.create(Items.LIGHTNING_ROD.weathering().unaffected());
    }
