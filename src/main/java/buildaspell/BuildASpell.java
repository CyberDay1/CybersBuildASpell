...
public class BuildASpell {
    ...
    public BuildASpell(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // when Modonomicon is present so the method reference doesn't force-load those
        // classes — and crash with NoClassDefFoundError — when it's absent at runtime.
    ...
    private static void registerClientModBusEvents(IEventBus modEventBus) {
        ...
        modEventBus.addListener(buildaspell.client.ClientSetup::onRegisterClientExtensions);
