...
public class SpellCommand {
    ...
    private static int giveTestKit(CommandContext<CommandSourceStack> context, ServerPlayer player) {
        ...
        Identifier manaPoolId = Identifier.fromNamespaceAndPath("buildaspell", "mana_pool");
        Identifier manaRegenId = Identifier.fromNamespaceAndPath("buildaspell", "mana_regeneration");
        Identifier spellPowerId = Identifier.fromNamespaceAndPath("buildaspell", "spell_power");
