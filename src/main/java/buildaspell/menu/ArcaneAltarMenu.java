...
public class ArcaneAltarMenu extends AbstractContainerMenu {
     ...
     * inventory or on the ground writes back to disk as a single item. Every other way out of the
     * container funnels through {@code Container#removeItem}, which clamps. The hotbar swap does
     * not: it hands {@code Slot#getItem()} straight to {@code Inventory#setItem}. Intercept that
     * one case and move a single stack instead.
     */
    @Override
