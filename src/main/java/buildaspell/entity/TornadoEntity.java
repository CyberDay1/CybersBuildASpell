...
public class TornadoEntity extends Entity {
    ...
    protected void readAdditionalSaveData(CompoundTag input) {
        ...
        this.duration = input.contains("Duration") ? input.getInt("Duration") : 100;
        ...
        this.liftStrength = input.contains("LiftStrength") ? input.getFloat("LiftStrength") : 0.5f;
        this.spinStrength = input.contains("SpinStrength") ? input.getFloat("SpinStrength") : 0.5f;
        ...
        this.moveX = input.contains("MoveX") ? input.getDouble("MoveX") : 0.0;
        this.moveZ = input.contains("MoveZ") ? input.getDouble("MoveZ") : 0.0;
        this.entityData.set(DATA_RANGE, range);
    }
    ...
    public AABB getBoundingBoxForCulling() {
        ...
        return new AABB(getX() - r, getY() - 1.0, getZ() - r,
                getX() + r, getY() + h, getZ() + r);
    }
