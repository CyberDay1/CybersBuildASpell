...
public class RuneMarkerEntity extends Entity {
    ...
    public void tick() {
        ...
        if (level().isClientSide()) {
            ...
            double radius = 0.5;
            Vec3 normal = Vec3.atLowerCornerOf(surfaceDirection.getUnitVec3i());
    ...
    protected void readAdditionalSaveData(ValueInput input) {
        ...
        this.hasExecuted = input.getBooleanOr("HasExecuted", false);
        this.surfaceDirection = Direction.from3DDataValue(input.getByteOr("SurfaceDirection", (byte) 0));
        this.trap = input.getBooleanOr("Trap", false);
