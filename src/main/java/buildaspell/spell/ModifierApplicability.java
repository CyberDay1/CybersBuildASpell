...
public final class ModifierApplicability {
    ...
    private static Map<SpellEffect, EnumSet<SpellModifier>> build() {
        ...
        SpellModifier CHAIN = SpellModifier.CHAIN;
        ...
        m.put(SpellEffect.DAMAGE, set(POWER, AREA, NULLIFY, CHAIN, FORTUNE, LEECH, SUNDER));
        ...
        m.put(SpellEffect.EXPLOSION, set(POWER, AREA, NULLIFY, CHAIN));
        m.put(SpellEffect.HEAL, set(POWER, AREA, NULLIFY, CHAIN, FORTUNE));
        m.put(SpellEffect.LIGHTNING, set(POWER, AREA, NULLIFY, CHAIN));
        ...
        m.put(SpellEffect.CREATE_WATER, set(AREA, CHAIN, WALL, FLOOR, FILL));
        m.put(SpellEffect.EVAPORATE_WATER, set(AREA, CHAIN, WALL, FLOOR, FILL));
