 ...
 *
 * <p>Each implementation registers a {@link MapCodec} under a {@link ResourceLocation}
...
public interface SpellPrimitive {
    ...
    Map<ResourceLocation, MapCodec<? extends SpellPrimitive>> TYPES = new HashMap<>();

    static void register(ResourceLocation id, MapCodec<? extends SpellPrimitive> codec) {
        TYPES.put(id, codec);
    }

    Codec<SpellPrimitive> CODEC = ResourceLocation.CODEC.dispatch(
            "type",
            SpellPrimitive::type,
            TYPES::get);
}
