 ...
 */
public class DeliveryRegistry extends SimplePreparableReloadListener<Map<Identifier, JsonElement>> {

    private static final String DIRECTORY = "spell_deliveries";
    private static final Map<Identifier, DeliveryDefinition> DEFS = new HashMap<>();
    ...
    public static DeliveryDefinition get(DeliveryMethod delivery) {
        return DEFS.get(Identifier.fromNamespaceAndPath(BuildASpell.MOD_ID, delivery.getSerializedName()));
    }
