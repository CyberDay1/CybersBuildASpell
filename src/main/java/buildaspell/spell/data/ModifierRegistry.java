 ...
 */
public class ModifierRegistry extends SimplePreparableReloadListener<Map<ResourceLocation, JsonElement>> {

    private static final String DIRECTORY = "spell_modifiers";
    private static final Map<ResourceLocation, ModifierDefinition> DEFS = new HashMap<>();
    ...
    public static ModifierDefinition get(SpellModifier modifier) {
        return DEFS.get(ResourceLocation.fromNamespaceAndPath(BuildASpell.MOD_ID, modifier.getSerializedName()));
    }
