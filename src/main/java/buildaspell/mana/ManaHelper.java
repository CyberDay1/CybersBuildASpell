...
public class ManaHelper {
    ...
    // Spell Power counts only on the main hand (weapon or wand) so a second held wand never stacks;
    // the mana enchantments count only on worn armour. Nothing is read from the off hand.
