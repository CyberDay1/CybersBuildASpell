...
- **Deeply configurable**: deliveries, effects, modifiers, and over 200 individual gameplay numbers are exposed across per-category config files; individual components can be disabled (and become unobtainable) server-side.
